...
export function SocialProviders({ mode = 'login' }: SocialProvidersProps) {
    ...
    const handleGoogleLogin = async () => {
        ...
        try {
            ...
            if (result.error) {
                showErrorToast(result.error.message || 'Failed to login with Google. Please try again.')
    ...
    const handleGitHubLogin = async () => {
        ...
        try {
            ...
            if (result.error) {
                showErrorToast(result.error.message || 'Failed to login with GitHub. Please try again.')
